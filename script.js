...
function renderEpisodes(episodeList) {
  ...
  episodeList.forEach((episode) => {
    ...
    const safeName = episode.name || "Untitled";
    const safeSummary = episode.summary || ""; // some episodes may not have a summary
    const imageUrl = episode.image && episode.image.medium ? episode.image.medium : null;
